...
public class Utility {
	...
	public static Map<String, Object> buildResponseMap(String message, int exitCode, String resultKey,
			Object resultVal) {
	...
	public static Map<String, Object> buildResultMap(String resultKey, Object resultVal) {
